...
public class MouseVisConfigDialog extends JDialog implements DocumentListener {
    ...
    public MouseVisConfigDialog() {
        super(null, "Mouse Capture Configuration", Dialog.ModalityType.APPLICATION_MODAL);
    }

    MouseVisConfigDialog(ProjectOrganization organization) {
        super(null, "Mouse Capture Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
    ...
    public static void main(String[] args) {
        ...
        MouseVisConfigDialog c = new MouseVisConfigDialog(o);
