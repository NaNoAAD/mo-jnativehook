...
public class KBDialog extends JDialog implements DocumentListener {
    ...
    public KBDialog() {
        super(null, "Keyboard Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
    }

    KBDialog(ProjectOrganization organization) {
        super(null, "Keyboard Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
